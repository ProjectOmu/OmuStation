...
public sealed class StationSpawningSystem : SharedStationSpawningSystem
{
    ...
    /// <param name="station">The station this player is being spawned on.</param>
    public void SetPdaAndIdCardData(EntityUid entity, string characterName, JobPrototype jobPrototype, EntityUid? station, HumanoidCharacterProfile? profile = null)
    {
        ...
        _cardSystem.TryChangeJobTitle(cardId, _alternateTitles.GetJobTitle(profile, jobPrototype), card);
