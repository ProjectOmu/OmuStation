...
using Content.Shared._Omu.Materials.Systems;
...
public sealed class NuclearReactorSystem : SharedNuclearReactorSystem
{
    ...
    private void UpdateAudio(Entity<NuclearReactorComponent> ent)
    {
        ...
        {
            if (!_audio.IsPlaying(comp.AlarmAudioHighThermal))
                comp.AlarmAudioHighThermal = _audio.PlayPvs(new SoundPathSpecifier("/Audio/_Omu/Machines/reactor_alarm_1.ogg"), uid, AudioParams.Default.WithLoop(true).WithVolume(-3))?.Entity;
        }
        else
            if (_audio.IsPlaying(comp.AlarmAudioHighThermal))
            comp.AlarmAudioHighThermal = _audio.Stop(comp.AlarmAudioHighThermal);
        ...
        {
            if (!_audio.IsPlaying(comp.AlarmAudioHighTemp))
                comp.AlarmAudioHighTemp = _audio.PlayPvs(new SoundPathSpecifier("/Audio/_Omu/Machines/reactor_alarm_2.ogg"), uid, AudioParams.Default.WithLoop(true).WithVolume(-3))?.Entity;
        }
        else
            if (_audio.IsPlaying(comp.AlarmAudioHighTemp))
            comp.AlarmAudioHighTemp = _audio.Stop(comp.AlarmAudioHighTemp);
        ...
        {
            if (!_audio.IsPlaying(comp.AlarmAudioHighRads))
                comp.AlarmAudioHighRads = _audio.PlayPvs(new SoundPathSpecifier("/Audio/_Omu/Machines/reactor_alarm_3.ogg"), uid, AudioParams.Default.WithLoop(true).WithVolume(-3))?.Entity;
        }
        else
            if (_audio.IsPlaying(comp.AlarmAudioHighRads))
            comp.AlarmAudioHighRads = _audio.Stop(comp.AlarmAudioHighRads);
