...
using Content.Shared._Omu.Power.Generation.FissionGenerator;
...
namespace Content.Server._Omu.Power.Generation.FissionGenerator;
...
public sealed class TurbineSystem : SharedTurbineSystem
{
    ...
    private readonly List<string> _damageSoundList = [
        "/Audio/_Omu/Effects/engine_grump1.ogg",
        "/Audio/_Omu/Effects/engine_grump2.ogg",
        "/Audio/_Omu/Effects/engine_grump3.ogg",
    ...
    private void OnUpdate(EntityUid uid, TurbineComponent comp, ref AtmosDeviceUpdateEvent args)
    {
        ...
        if (comp.Ruined || AirContents.Temperature >= comp.MaxTemp)
        {
            ...
            {
                comp.AlarmAudioOvertemp = _audio.PlayPvs(new SoundPathSpecifier("/Audio/_Omu/Machines/alarm_buzzer.ogg"), uid, AudioParams.Default.WithLoop(true))?.Entity;
        ...
        if (!comp.Ruined && AirContents != null)
        {
            ...
            if (!_audio.IsPlaying(comp.AlarmAudioUnderspeed) && !comp.Undertemp && comp.FlowRate > 0 && comp.Stalling)
                 PlayAudio(new SoundPathSpecifier("/Audio/_Omu/Machines/alarm_beep.ogg"), uid, out comp.AlarmAudioUnderspeed, AudioParams.Default.WithLoop(true).WithVolume(-4));
            ...
            if (comp.RPM > 10)
            {
                ...
                _audio.PlayPvs(new SoundPathSpecifier("/Audio/_Omu/Ambience/Objects/turbine_room.ogg"), uid, AudioParams.Default.WithPitchScale(comp.RPM / comp.BestRPM).WithVolume(-2));
            }
