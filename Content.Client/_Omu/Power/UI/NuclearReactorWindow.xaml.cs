        ...
        for (var x = 0; x < _gridWidth; x++)
        {
            for (var y = 0; y < _gridHeight; y++)
            {
                ...
                var icon = new TextureRect() {
                    SetSize = new(32, 32),
                    TexturePath = "/Textures/_Omu/Structures/Power/Generation/FissionGenerator/reactor_part_inserted/base.png"
                };
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        for (var x = 0; x < _gridWidth; x++)
        {
            for (var y = 0; y < _gridHeight; y++)
            {
                ...
                _reactorRect[vect].TexturePath = "/Textures/_Omu/Structures/Power/Generation/FissionGenerator/reactor_part_inserted/" +  icon + ".png";
            }
        }
