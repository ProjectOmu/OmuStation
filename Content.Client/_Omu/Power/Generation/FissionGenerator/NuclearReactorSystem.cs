...
namespace Content.Client._Omu.Power.Generation.FissionGenerator;
...
public sealed class NuclearReactorSystem : SharedNuclearReactorSystem
{
    ...
    private void OnInit(EntityUid uid, NuclearReactorComponent comp, ref ComponentInit args)
    {
        ...
        if (!_resourceCache.TryGetResource("/Textures/_Omu/Structures/Power/Generation/FissionGenerator/reactor_component_cap.rsi", out RSIResource? resource))
            return;
