...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private readonly JobAlternateTitleSystem _alternateTitles;
            ...
            MarkingManager markings)
        {
            ...
            _alternateTitles = _entManager.System<JobAlternateTitleSystem>();
        ...
        public void RefreshJobs()
        {
            ...
            var alternateTitlesByJob = _alternateTitles.Enabled ? _alternateTitles.GetTitlesByJob() : null;
                ...
                foreach (var job in jobs)
                {
                    ...
                    if (alternateTitlesByJob != null && alternateTitlesByJob.TryGetValue(job.ID, out var alternateTitles))
                    {
                        ...
                        selector.OnAlternateTitleSelected += title =>
                        {
                            ...
                            {
                                if (jobId == job.ID && other != selector)
                                    other.SelectAlternateTitle(title);
                            }
