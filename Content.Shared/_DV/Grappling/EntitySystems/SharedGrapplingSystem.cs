...
public sealed partial class SharedGrapplingSystem : EntitySystem
{
    ...
    private void StartGrapple(Entity<GrapplerComponent> grappler, EntityUid victim)
    {
        ...
        if (grappler.Comp.ActivationMode is GrapplerActivationStaminaDrain drain)
        {
            ...
            _stamina.ToggleStaminaDrain(victim, drain.StaminaDrainRate, true, true, "grapple", grappler);
    ...
    private void ActivateGrapplingForVictim(Entity<GrappledComponent> victim)
    {
        ...
        _stamina.ToggleStaminaDrain(victim, 0, false, false, "grapple", victim.Comp.Grappler);
    }
        ...
        bool manualRelease = false)
    {
        ...
        _stamina.ToggleStaminaDrain(victim, 0, false, false, "grapple", grappler);
