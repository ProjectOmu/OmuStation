...
namespace Content.Shared.Interaction
{
    ...
    public abstract partial class SharedInteractionSystem : EntitySystem
    {
            ...
            bool checkCanUse = true)
        {
            ...
            DoContactInteraction(user, used, null, true, interactUsingEvent, true);// Stellar - interaction particles
            DoContactInteraction(user, target, used, true, interactUsingEvent, true);// Stellar - interaction particles
        ...
        public void DoContactInteraction(EntityUid uidA, EntityUid? uidB, EntityUid? used = null, bool predicted = true, HandledEntityEventArgs? args = null, bool interactionParticles = true) // Stellar/ES - interaction particles
        {
