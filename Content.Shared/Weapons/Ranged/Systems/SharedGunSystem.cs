...
public abstract partial class SharedGunSystem : EntitySystem
{
                ...
                case HitscanPrototype hitscan:
                    ...
                    if (hitscan.Reflective != ReflectType.None)
                    {
                        for (var reflectAttempt = 0; reflectAttempt < 3; reflectAttempt++)
                        {
                            ...
                            var ev = new HitScanReflectAttemptEvent(user, gunUid, hitscan.Reflective, dir, false, hitscan.Damage); // Omu, add damage argument for RMC port
    ...
    public Angle[] LinearSpread(Angle start, Angle end, int intervals) // Omu, set to public for specifically spell cards
    {
    ...
    public virtual void ShootProjectile(EntityUid uid, Vector2 direction, Vector2 gunVelocity, EntityUid? gunUid, EntityUid? user = null, float speed = 20f, Vector2? targetCoordinates = null)
    {
