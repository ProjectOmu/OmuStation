ghost-role-information-voidwalker-name = V??oid Walker
...
voidwalker-nebula-jaunt-fail = You must stand on Nebula Vomit!
voidwalker-action-fail-require-in-space = You must be in space to use this ability!
