crafting-menu-name-FDB = forged double-barreled shotgun
...
crafting-menu-text-IR = An odd double-barreled revolver with no cylinder. The unique construction lowers the chance of a backfire, but does not eliminate it.
